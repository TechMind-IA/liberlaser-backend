...
import {
  LimitsModal
} from "./chunk-Q57CE5UZ.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-MEEQRWTK.js";
import {
  getStageColorByHex
} from "./chunk-NA445DG5.js";
import {
...
} from "./chunk-JQUE2JV6.js";
import {
  useTypedSelector
} from "./chunk-5UVFVLBC.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-OJA7PJUB.js";
import {
  index
} from "./chunk-DUH5XCOF.js";
import {
...
} from "./chunk-IXB526PO.js";
import {
  useConfig
} from "./chunk-HN6NWAFP.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer2,
  require_baseUniq
} from "./chunk-3Y3Q3ATM.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-PXURLERB.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-WRFUHP3I.js";
import {
  renderAdmin
} from "./chunk-GAKLYFDI.js";
import {
  useAIAvailability
} from "./chunk-BWJQEECQ.js";
import {
  require_isArrayLikeObject,
  require_omit
} from "./chunk-DLUESPU4.js";
import {
  require_cloneDeep
} from "./chunk-KW3KTYN5.js";
import {
  require_baseRest
} from "./chunk-ZAETUR3B.js";
import {
  Form,
  Formik,
  useFormik
} from "./chunk-L2AX6657.js";
import {
  useLicenseLimits
} from "./chunk-E5666OMI.js";
import {
  Table,
  useTable
} from "./chunk-W44DXC2C.js";
import {
  useAdminUsers
} from "./chunk-C66SAOYP.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
  require_has
} from "./chunk-CWSNCXLO.js";
import {
  useField,
  useForm
} from "./chunk-KOSXGWVH.js";
import {
  useRBAC
} from "./chunk-WIQAI7OI.js";
import {
  K,
  Page,
  useAPIErrorHandler
} from "./chunk-TBPLOZ7V.js";
import {
  useAuth,
  useQueryParams
} from "./chunk-M3Q6PTTQ.js";
import {
  useNotification
} from "./chunk-4JM6HHBW.js";
import {
  adminApi,
  isFetchError,
  require_baseFlatten,
  ...
  require_lib,
  skipToken
} from "./chunk-HAGDOREI.js";
import {
  useDispatch,
  useSelector
} from "./chunk-OX6DEIJW.js";
import {
  useIntl
} from "./chunk-2GO4TSFA.js";
import {
  Link,
  NavLink,
  matchPath,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-JUWDM5K2.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-SZZCZDEG.js").then((mod) => ({
...
var SearchAsset = ({ onChangeSearch, queryValue = null }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(st2, {
    label: "Search",
            ...
            (assetCount > 0 || folderCount > 0 || isSearching) && (0, import_jsx_runtime6.jsxs)(T, {
              ...
              children: [
                (0, import_jsx_runtime6.jsx)(ActionContainer, {
                  paddingTop: 1,
                  paddingBottom: 1,
                  children: (0, import_jsx_runtime6.jsx)(st2, {
            ...
            children: folders.map((folder) => {
              ...
              return (0, import_jsx_runtime6.jsx)(Um.Item, {
                ...
                children: (0, import_jsx_runtime6.jsx)(FolderCard, {
                  ...
                  cardActions: onEditFolder && (0, import_jsx_runtime6.jsx)(st2, {
                    withTooltip: false,
                    label: formatMessage({
...
var CarouselAssetActions = ({ asset, onDeleteAsset, onAddAsset, onEditAsset }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(jm, {
    children: [
      onAddAsset && (0, import_jsx_runtime12.jsx)(st2, {
        label: formatMessage({
      ...
      onDeleteAsset && (0, import_jsx_runtime12.jsx)(st2, {
        label: formatMessage({
          id: "global.delete",
      ...
      onEditAsset && (0, import_jsx_runtime12.jsx)(st2, {
        label: formatMessage({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-B4NM432X.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-B6Z5NU3H.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-XIEE7KKT.js");
        return {
              ...
              children: rows.map(({ locale, status }, index4) => {
                ...
                return status && locale ? (0, import_jsx_runtime18.jsxs)(Table.Row, {
                  children: [
                    ...
                    (0, import_jsx_runtime18.jsx)(Table.Cell, {
                      children: (0, import_jsx_runtime18.jsx)(st2, {
                        tag: Link,
                        to: {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-33EJCFZJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-M5CLSX6K.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-H4E5DLQH.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-EWBXQRQD.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-D52OJARR.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-V3AQKXLQ.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-RJOCVECR.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NJ4LWOGM.js");
          return {
...
//# sourceMappingURL=chunk-4D2FXHDP.js.map
